            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admins.storeProps') }}" enctype="multipart/form-data">
                        ...
                        <select name="home_type" class="form-control mt-3 mb-4 form-select" aria-label="Default select example">
                            <option selected>Select Type Home</option>
                            @foreach($homeTypes as $homeType)
                                <option value="{{ $homeType->id }}">{{ $homeType->hometypes }}</option>
                            @endforeach
                        </select>
