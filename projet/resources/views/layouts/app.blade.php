...
<style>
    /* Cible tous les liens de la navbar */
.site-navbar .site-menu a {
    color: black !important;  /* Change la couleur du texte en noir */
}

/* Vous pouvez aussi cibler les éléments de la dropdown si nécessaire */
.site-navbar .nav-item.dropdown a {
    color: black !important;  /* Change la couleur du texte du lien du dropdown */
}
        ...
        <div class="container py-1">
            <div class="row align-items-center">
                <div class="col-8 col-md-8 col-lg-4">
                    <h1 class="mb-0"><a href="{{ url('/') }}" class="h2 mb-0"><strong>Homeland<span class="text-danger">.</span></strong></a></h1>
                </div>
