...
@section('content')
            ...
            <div class="site-blocks-cover overlay"
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center text-center">
                        <div class="col-md-10">
                            <span class="d-inline-block bg-{{ $prop->type == 'Buy' ? 'success' : ($prop->type == 'Rent' ? 'success' : 'warning') }} text-white px-3 mb-3 property-offer-type rounded">
                                {{ $prop->type }}
                            </span>
    ...
    <form method="get" action="{{ url('/filter') }}" class="container my-5">
        <div class="row">
            <div class="col-md-4">
